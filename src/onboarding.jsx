    ...
    <div className="ob-hero">
      ...
      <div className="ob-hero-content">
        ...
        <h2 className="ob-title">
          ...
          <em>welcome to the Lions family.</em>
        </h2>
        <p className="ob-desc">
          You're now the chair of <strong>{club.name}</strong> on the Smart Club platform — the
          digital home for every cricket club in the KZNCU &amp; EMCU leagues.
        </p>
        <p className="ob-desc">
          We'll walk you through what's required before <strong>22 June 2026</strong>, then hand
  ...
  const items = [
    {
      ...
      d: 'Club details, executive committee & leagues entered. Concludes with the R 4,500 union fee.',
      tag: '~ 5 min',
    },
    {
      i: <Icon.Upload />,
    ...
    },
    {
      ...
      d: '25 questions across admin, teams, coaching, facilities and representation. Live-scored out of 100.',
      tag: '~ 8 min',
    },
  ];
  return (
    <div className="ob-panel">
      ...
      <h2 className="ob-title">
        Three submissions <em>before 22 June 2026</em>
      </h2>
